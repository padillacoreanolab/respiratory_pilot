...
def get_data_from_rec_file(rec_file):
    ...
    try:
        ...
        resp_signal = resp[fname]['analog']['analog_ECU_Ain1']['data']['voltage'].astype(float)
    except Exception as e:
        resp_signal = None
...
if __name__ == "__main__":
    ...
    output_dir = r"C:\Users\thoma\Code\ResearchCode\respiratory_pilot\src\file_conversion\day1_h5_files"
